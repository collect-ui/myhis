...
- 在 `params.*.template` 中生成 `pw_week` 相关值。
...
params:
  demo:
    template: '{{pw_week .value}}'
```

## 注意事项

### 定位
- 悬停命中文档路径：`tooltip-docs/python/key/template/value/pw_week.md`
