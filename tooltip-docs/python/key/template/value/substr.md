...
- 在 `params.*.template` 中生成 `substr` 相关值。
...
params:
  demo:
    template: '{{substr .code 0 8}}'
```

## 注意事项

### 定位
- 悬停命中文档路径：`tooltip-docs/python/key/template/value/substr.md`
