...
- 在 `params.*.template` 中生成 `get_key` 相关值。
...
params:
  demo:
    template: '{{get_key "app_name"}}'
```

## 注意事项

### 定位
- 悬停命中文档路径：`tooltip-docs/python/key/template/value/get_key.md`
