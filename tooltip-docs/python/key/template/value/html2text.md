...
- 在 `params.*.template` 中生成 `html2text` 相关值。
...
### 参数
- 参数形式以实现类 `Html2text` 的 `filter` 方法为准。
...
params:
  demo:
    template: '{{html2text .html}}'
```

## 注意事项

### 定位
- 悬停命中文档路径：`tooltip-docs/python/key/template/value/html2text.md`
