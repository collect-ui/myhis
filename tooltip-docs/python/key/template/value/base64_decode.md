# template function=base64_decode
...
- 在 `params.*.template` 中生成 `base64_decode` 相关值。
...
### 参数
- 参数形式以实现类 `Base64DecodeFilter` 的 `filter` 方法为准。
...
params:
  demo:
    template: '{{base64_decode .content_b64}}'
```

## 注意事项

### 定位
- 悬停命中文档路径：`tooltip-docs/python/key/template/value/base64_decode.md`
