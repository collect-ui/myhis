...
- 在 `params.*.template` 中生成 `first_item` 相关值。
...
### 参数
- 调用签名：`func FirstItem(list []interface{})`
...
params:
  demo:
    template: '{{first_item .list}}'
```

## 注意事项

### 定位
- 悬停命中文档路径：`tooltip-docs/go/key/template/value/first_item.md`
