...
- 在 `params.*.template` 中生成 `multiply` 相关值。
...
### 参数
- 调用签名：`func Multiply(a, b interface{})`
...
params:
  demo:
    template: '{{multiply .price .qty}}'
```

## 注意事项

### 定位
- 悬停命中文档路径：`tooltip-docs/go/key/template/value/multiply.md`
