...
- 在 `params.*.template` 中生成 `random_int` 相关值。
...
### 参数
- 调用签名：`func RandomInt(min, max int)`
...
### 定位
- 悬停命中文档路径：`tooltip-docs/go/key/template/value/random_int.md`
