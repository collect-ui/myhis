...
- 在 `params.*.template` 中生成 `to_json` 相关值。
...
params:
  demo:
    template: '{{to_json .detail}}'
```

## 注意事项

### 定位
- 悬停命中文档路径：`tooltip-docs/go/key/template/value/to_json.md`
