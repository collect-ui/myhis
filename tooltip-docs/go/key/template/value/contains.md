...
- 在 `params.*.template` 中生成 `contains` 相关值。
...
### 参数
- 调用签名：`func Contains(arr []interface{}, str interface{})`
...
params:
  demo:
    template: '{{contains .role_list "admin"}}'
```

## 注意事项

### 定位
- 悬停命中文档路径：`tooltip-docs/go/key/template/value/contains.md`
