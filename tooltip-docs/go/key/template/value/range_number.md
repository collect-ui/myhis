# template function=range_number
...
- 在 `params.*.template` 中生成 `range_number` 相关值。
...
params:
  demo:
    template: '{{range_number 5}}'
```

## 注意事项

### 定位
- 悬停命中文档路径：`tooltip-docs/go/key/template/value/range_number.md`
