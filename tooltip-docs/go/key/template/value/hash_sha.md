...
- 在 `params.*.template` 中生成 `hash_sha` 相关值。
...
params:
  demo:
    template: '{{hash_sha .password}}'
```

## 注意事项

### 定位
- 悬停命中文档路径：`tooltip-docs/go/key/template/value/hash_sha.md`
