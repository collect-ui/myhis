...
- 在 `params.*.template` 中生成 `divide` 相关值。
...
### 参数
- 调用签名：`func Divide(a, b interface{})`
...
params:
  demo:
    template: '{{divide .total .count}}'
```

## 注意事项

### 定位
- 悬停命中文档路径：`tooltip-docs/go/key/template/value/divide.md`
